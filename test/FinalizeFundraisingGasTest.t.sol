...
import "../src/DaosWorldV1.sol";
import "../src/DaosWorldV1Token.sol";

contract GasTest is Test {
    DaosWorldV1 public daosWorld;
    address[] public users;
    uint256 constant NUM_USERS = 100;
    uint256 constant CONTRIBUTION_AMOUNT = 0.1 ether;
    ...
    function setUp() public {
        ...
        uint256 maxWhitelistAmount = 1 ether; // 1000000000000000000
        uint256 maxPublicContributionAmount = 0.1 ether; // 100000000000000000
        address protocolAdmin = address(this);

        daosWorld = new DaosWorldV1(
            fundraisingGoal,
            name,
            symbol,
            fundraisingDeadline,
    ...
    function testMaxContributors() public {
        console2.log("GasTest.testMaxContributors");
        ...
        try daosWorld.finalizeFundraising(initialTick, upperTick, salt) {
            ...
            vm.expectRevert();
            daosWorld.finalizeFundraising(initialTick, upperTick, salt);
        }
    }
}
